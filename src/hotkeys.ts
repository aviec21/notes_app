...
export const SHORTCUTS: { group: string; keys: string; description: string }[] = [
  ...
  { group: 'Notes list', keys: 'F2', description: 'Rename the selected note or folder' },
  { group: 'Notes list', keys: 'E', description: 'Turn editor mode (side panel) on / off' },
  ...
  { group: 'Editing a note', keys: 'Ctrl+B', description: 'Bold' },
  { group: 'Editing a note', keys: 'Ctrl+I', description: 'Italic' },
  { group: 'Editing a note', keys: 'Ctrl+U', description: 'Underline' },
  { group: 'Editing a note', keys: 'Ctrl+Shift+S', description: 'Strikethrough' },
  { group: 'Editing a note', keys: 'Ctrl+,  /  Ctrl+.', description: 'Subscript / superscript' },
  { group: 'Editing a note', keys: 'Ctrl+Shift+8', description: 'Bulleted list' },
  { group: 'Editing a note', keys: 'Ctrl+Shift+7', description: 'Numbered list' },
  { group: 'Editing a note', keys: 'Ctrl+Shift+9', description: 'Checklist' },
  { group: 'Editing a note', keys: 'Tab / Shift+Tab', description: 'Indent / outdent a list item' },
